<?php 
	...
	include "models/ModelSlides.php";
	class ControllerSlides extends Controller{
		...
		public function index(){
			...
			$this->loadView("ViewSlides.php",array("data"=>$data,"numPage"=>$numPage));
		}
		public function update(){
			...
			//goi view, truyen du lieu ra view
			$this->loadView("ViewFormSlides.php",array("record"=>$record,"action"=>$action));
		}
		...
		public function create(){
			...
			//goi view, truyen du lieu ra view
			$this->loadView("ViewFormSlides.php",array("action"=>$action));
		}
